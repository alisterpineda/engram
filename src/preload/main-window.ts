...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  entry: {
    create: (contentJson: string, contentHtml: string, parentId?: number | null, startedAt?: Date, endedAt?: Date | null) =>
      ipcRenderer.invoke('entry:create', contentJson, contentHtml, parentId, startedAt?.toISOString(), endedAt?.toISOString()),
    getById: (id: number) =>
    ...
    update: (id: number, contentJson: string, contentHtml: string, startedAt?: Date, endedAt?: Date | null) =>
      ipcRenderer.invoke('entry:update', id, contentJson, contentHtml, startedAt?.toISOString(), endedAt?.toISOString()),
    delete: (id: number) =>
